...
INCLUDES = [
  ...
  os.path.join('.', 'occt', 'src', 'BRepExtrema', 'BRepExtrema_DistShapeShape.hxx'),
  ...
  os.path.join('.', 'occt', 'src', 'gp', 'gp_Trsf2d.hxx'),
  ...
  os.path.join('.', 'occt', 'src', 'GeomAPI', 'GeomAPI_ProjectPointOnSurf.hxx'),
  ...
  os.path.join('.', 'occt', 'src', 'BRepLib', 'BRepLib_FuseEdges.hxx'),
  ...
  os.path.join('.', 'occt', 'src', 'BRepTools', 'BRepTools.hxx'),
